              ...
              .map(
                (participant) => `
                  <li>
                    ...
                    <button class="participant-remove" type="button" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}" title="Remove participant">&times;</button>
                  </li>`
              )
              .join("")
